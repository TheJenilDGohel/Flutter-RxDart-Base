...
import 'package:{{project_name}}/{{#feature_path}}{{feature_path}}/{{/feature_path}}{{^feature_path}}features/{{/feature_path}}{{feature_name.snakeCase()}}/repo/{{feature_name.snakeCase()}}_repo.dart';
